 ...
 * @Last Modified time: 2020-05-09 23:46:06
 */
...
HTML;
        ...
        return <<<HTML
<div class="debugging-hints-advanced" style="position: relative; border: 1px dotted blue; margin: 6px 2px; padding: 18px 2px 2px 2px;">
{$hintsHtml}
{$blockHtml}
</div>
HTML;
