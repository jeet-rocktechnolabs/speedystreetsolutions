 ...
 * @Last Modified time: 2020-05-12 19:16:25
 */
            ...
            switch ($class) {
                ...
                case 'Magiccart\Magicproduct\Block\Widget\Catalog':
                    if (!$quickedit) {
                        ...
                        if (!$magicproduct) {
                            ...
                            $collection     = \Magento\Framework\App\ObjectManager::getInstance()->get('Magiccart\Magicproduct\Model\MagicproductFactory');
                            $magicproduct   = $collection->create()->getCollection( $identifier, 'identifier')
                ...
                case 'Magiccart\Magicslider\Block\Widget\Slider':
                    if (!$quickedit) {
                        ...
                        if (!$magicslider) {
                            $identifier     = $block->getIdentifier();
                            $collection     = \Magento\Framework\App\ObjectManager::getInstance()->get('Magiccart\Magicslider\Model\MagicsliderFactory');
                            $magicslider    = $collection->create()->load( $identifier, 'identifier');
                            if($magicslider){
                                ...
                                $quickedit  = [
                                    ...
                                    [
                                        'title' => __('%1 > %2 Identifier is: %3', $moduleName, $class, $magicslider->getIdentifier()),
                                        'url'   => $editUrl
                                    ],
                                    [
                                        'title' => __('Edit'),
                    ...
                    if (!$quickedit) {
                        ...
                        if($lookbook){
                            ...
                            $quickedit  = [
                                ...
                                [
                                    'title' => __('System > Stores > Configuration > Magiccart > Lookbook'),
                                    'url'   => $configUrl
                                ],
                                [
                                    'title' => __('Edit'),
                    ...
                    if (!$quickedit) {
                        ...
                        if($testimonials){
                            ...
                            $quickedit  = [
                                ...
                                [
                                    'title' => __('System > Stores > Configuration > Magiccart > Testimonial'),
                                    'url'   => $configUrl
                                ],
                                [
                                    'title' => __('Edit'),
