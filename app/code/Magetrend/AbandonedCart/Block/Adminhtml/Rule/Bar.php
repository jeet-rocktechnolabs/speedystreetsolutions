...
/**
 * Backend bar rule grid container block
 *
 * @category MageTrend
 * @package  Magetend/AbandonedCart
 * @author   Edvinas Stulpinas <edwin@magetrend.com>
 ...
 * @link     https://www.magetrend.com/magento-2-abandoned-cart
 */
class Bar extends \Magento\Backend\Block\Widget\Grid\Container
{
    /**
    ...
    public function getCreateUrl()
    {
        return  $this->getUrl(
            'abandonedcart/*/new',
            ['content_type' => \Magetrend\AbandonedCart\Model\Rule::TYPE_BAR]
        );
    }
}
