...
/**
 * Cart rule management controller class
 *
 * @category MageTrend
 * @package  Magetend/AbandonedCart
 * @author   Edvinas Stulpinas <edwin@magetrend.com>
...
class Index extends \Magetrend\AbandonedCart\Controller\Adminhtml\Rule
{
    ...
    public function execute()
    {
        ...
        $this->_setActiveMenu('Magetrend_AbandonedCart::cart_rule_index');
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Cart Rules'));

        $this->_addBreadcrumb(__('Abandoned Cart'), __('Abandoned Cart'));
        $this->_addBreadcrumb(__('Abandoned Cart'), __('Cart Rules'));
