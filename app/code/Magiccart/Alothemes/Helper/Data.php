 ...
 * @@Modify Date: 2020-04-28 16:14:15
 * @@Function:
 */
...
if(!empty($_product->getPrice())){
    ...
    public function getConfgRUC($type) // with Type = 'related' || 'upsell' || 'crosssell'
    {
        ...
        if($data['slide']){
            ...
            $Rm = array('slide', 'visible', 'widescreen', 'desktop', 'notebook', 'tablet', 'landscape', 'portrait', 'mobile'); // require with slick
