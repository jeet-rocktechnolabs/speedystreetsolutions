...
use Magmodules\GoogleShopping\Model\Config\Repository as ConfigRepository;
...
class VersionCheck extends Field
{
     ...
     * @var string
     */
    protected $_template = 'Magmodules_GoogleShopping::system/config/button/version.phtml';
    /**
    ...
    {
        return $this->getUrl('googleshopping/versionCheck/index');
    }
    ...
    {
        return $this->getUrl('googleshopping/versionCheck/changelog');
    }
