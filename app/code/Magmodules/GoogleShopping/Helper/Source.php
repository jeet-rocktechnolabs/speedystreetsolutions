...
use Magmodules\GoogleShopping\Model\System\Config\Source\IncludeProductType;

class Source extends AbstractHelper
{

    public const LIMIT_PREVIEW = 100;

    public const XPATH_ID = 'magmodules_googleshopping/data/id_attribute';
    public const XPATH_NAME = 'magmodules_googleshopping/data/name_attribute';
    public const XPATH_DESCRIPTION = 'magmodules_googleshopping/data/description_attribute';
    public const XPATH_IMAGE_SOURCE = 'magmodules_googleshopping/data/image';
    public const XPATH_IMAGE_MAIN = 'magmodules_googleshopping/data/main_image';
    public const XPATH_CONDITION_TYPE = 'magmodules_googleshopping/data/condition_type';
    public const XPATH_CONDITION_DEFAULT = 'magmodules_googleshopping/data/condition_default';
    public const XPATH_CONDITION_SOURCE = 'magmodules_googleshopping/data/condition_attribute';
    public const XPATH_GTIN = 'magmodules_googleshopping/data/gtin_attribute';
    public const XPATH_BRAND = 'magmodules_googleshopping/data/brand_attribute';
    public const XPATH_MPN = 'magmodules_googleshopping/data/mpn_attribute';
    public const XPATH_IDENTIFIER = 'magmodules_googleshopping/data/identifier_exists';
    public const XPATH_COLOR = 'magmodules_googleshopping/data/color_attribute';
    public const XPATH_MATERIAL = 'magmodules_googleshopping/data/material_attribute';
    public const XPATH_PATTERN = 'magmodules_googleshopping/data/pattern_attribute';
    public const XPATH_SIZE = 'magmodules_googleshopping/data/size_attribute';
    public const XPATH_SIZETYPE = 'magmodules_googleshopping/data/sizetype_attribute';
    public const XPATH_SIZESYTEM = 'magmodules_googleshopping/data/sizesystem_attribute';
    public const XPATH_GENDER = 'magmodules_googleshopping/data/gender_attribute';
    public const XPATH_EXTRA_FIELDS = 'magmodules_googleshopping/advanced/extra_fields';
    public const XPATH_URL_UTM = 'magmodules_googleshopping/advanced/url_utm';
    public const XPATH_SHIPPING = 'magmodules_googleshopping/advanced/shipping';
    public const XPATH_TAX = 'magmodules_googleshopping/advanced/tax';
    public const XPATH_INCLUDE_WEIGHT = 'magmodules_googleshopping/advanced/weight';
    public const XPATH_WEIGHT_UNIT = 'general/locale/weight_unit';
    public const XPATH_CATEGORY = 'magmodules_googleshopping/data/category';
    public const XPATH_INCLUDE_PRODUCT_TYPE = 'magmodules_googleshopping/data/include_product_type';
    public const XPATH_PRODUCT_TYPE_ATTRIBUTE = 'magmodules_googleshopping/data/product_type_attribute';
    public const XPATH_VISBILITY = 'magmodules_googleshopping/filter/visbility_enabled';
    public const XPATH_VISIBILITY_OPTIONS = 'magmodules_googleshopping/filter/visbility';
    public const XPATH_CATEGORY_FILTER = 'magmodules_googleshopping/filter/category_enabled';
    public const XPATH_CATEGORY_FILTER_TYPE = 'magmodules_googleshopping/filter/category_type';
    public const XPATH_CATEGORY_IDS = 'magmodules_googleshopping/filter/category';
    public const XPATH_STOCK = 'magmodules_googleshopping/filter/stock';
    public const XPATH_ADVANCED = 'magmodules_googleshopping/generate/advanced';
    public const XPATH_PAGING = 'magmodules_googleshopping/generate/paging';
    public const XPATH_DEBUG_MEMORY = 'magmodules_googleshopping/generate/debug_memory';
    public const XPATH_FILTERS = 'magmodules_googleshopping/filter/filters';
    public const XPATH_FILTERS_DATA = 'magmodules_googleshopping/filter/filters_data';
    public const XPATH_CONFIGURABLE = 'magmodules_googleshopping/types/configurable';
    public const XPATH_CONFIGURABLE_LINK = 'magmodules_googleshopping/types/configurable_link';
    public const XPATH_CONFIGURABLE_IMAGE = 'magmodules_googleshopping/types/configurable_image';
    public const XPATH_CONFIGURABLE_PARENT_ATTS = 'magmodules_googleshopping/types/configurable_parent_atts';
    public const XPATH_CONFIGURABLE_NONVISIBLE = 'magmodules_googleshopping/types/configurable_nonvisible';
    public const XPATH_BUNDLE = 'magmodules_googleshopping/types/bundle';
    public const XPATH_BUNDLE_LINK = 'magmodules_googleshopping/types/bundle_link';
    public const XPATH_BUNDLE_IMAGE = 'magmodules_googleshopping/types/bundle_image';
    public const XPATH_BUNDLE_PARENT_ATTS = 'magmodules_googleshopping/types/bundle_parent_atts';
    public const XPATH_BUNDLE_NONVISIBLE = 'magmodules_googleshopping/types/bundle_nonvisible';
    public const XPATH_GROUPED = 'magmodules_googleshopping/types/grouped';
    public const XPATH_GROUPED_LINK = 'magmodules_googleshopping/types/grouped_link';
    public const XPATH_GROUPED_IMAGE = 'magmodules_googleshopping/types/grouped_image';
    public const XPATH_GROUPED_PARENT_PRICE = 'magmodules_googleshopping/types/grouped_parent_price';
    public const XPATH_GROUPED_PARENT_ATTS = 'magmodules_googleshopping/types/grouped_parent_atts';
    public const XPATH_GROUPED_NONVISIBLE = 'magmodules_googleshopping/types/grouped_nonvisible';
    public const XPATH_MANAGE_STOCK = 'cataloginventory/item_options/manage_stock';
    public const XPATH_FORCE_SECURE_URLS = 'magmodules_googleshopping/advanced/force_secure';
    ...
    public function getConfig($storeId, $type)
    {
        ...
        $config['force_secure'] = $this->generalHelper->isSetFlag(self::XPATH_FORCE_SECURE_URLS, $storeId);
    ...
    public function getAttributes($type, $filters = [])
    {
        ...
        $attributes['product_type'] = [
            'source' => $this->generalHelper->getStoreValue(self::XPATH_INCLUDE_PRODUCT_TYPE),
    ...
    public function reformatData($dataRow, $product, $config, $parent)
    {
        ...
        if ($config['force_secure']) {
            foreach (['g:image_link', 'g:link', 'g:additional_image_link'] as $field) {
                if (isset($dataRow[$field]) && !is_array($dataRow[$field])) {
                    $dataRow[$field] = str_replace('http://', 'https://', $dataRow[$field]);
                }
                if (isset($dataRow[$field]) && is_array($dataRow[$field])) {
                    foreach ($dataRow[$field] as $key => $value) {
                        $dataRow[$field][$key] = str_replace('http://', 'https://', $dataRow[$field][$key]);
                    }
                }
            }
        }
    ...
    public function getCategoryData($product, $config, $parent)
    {
        ...
        switch ($this->generalHelper->getStoreValue(self::XPATH_INCLUDE_PRODUCT_TYPE)) {
            case IncludeProductType::INCLUDE_PRODUCT_TYPE_YES:
                if (!empty($deepestCategory)) {
                    $path['g:product_type'] = implode(' > ', $deepestCategory['path']);
                }
                break;
            case IncludeProductType::INCLUDE_PRODUCT_TYPE_YES_LAST_CATEGORY:
                if (!empty($deepestCategory)) {
                    $path['g:product_type'] = $deepestCategory['name'];
                }
                break;
            case IncludeProductType::INCLUDE_PRODUCT_TYPE_ATTRIBUTE:
                if ($productTypeAttribute =
                    $this->generalHelper->getStoreValue(self::XPATH_PRODUCT_TYPE_ATTRIBUTE)) {
                    $path['g:product_type'] = $product->getData($productTypeAttribute);
                }
                break;
        }
